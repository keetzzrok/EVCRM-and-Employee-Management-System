...
<section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <h1 class="Page_const"><?php echo "Welcome ". $_SESSION['username']?>! </h1>
      <div style="font-size: 30px;" class="row">You can now build an attractive resume!</div>
    </div>
  </section>
<!-- End Hero -->
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-info">
            ...
            <p>BMS College of Engineering</p>
              ...
              <strong>Email:</strong><a href=" mailto: keerthanak.is20@bmsce.ac.in"> keerthanak.is20@bmsce.ac.in</a><br>
              <strong>Email:</strong><a href=" mailto:  omkatkam.is20@bmsce.ac.in"> omkatkam.is20@bmsce.ac.in</a><br>
            </p>
